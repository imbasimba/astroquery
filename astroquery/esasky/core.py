...
class ESASkyClass(EsaTap):
    ...
    @deprecated_renamed_argument('tap_handler', None, since='8.0', message="The 'tap_handler' parameter is deprecated and will be removed in a future version. Use the ESASky instance directly for TAP queries (Using esa.utils.EsaTap and PyVO).")
